...
document.querySelector("#btn7").addEventListener("click", function() {
	...
	fetch(ctx + "/ex43/sub07", {method : "post", body : data});
});

document.querySelector("#btn6").addEventListener("click", function(){
	fetch(ctx + "/ex43/sub06", {method : "post", headers : {"Content-Tpye": "application/x-www-form-urlencoded"}, body : "name=son&email=ab+c@gmail.com"});
});

document.querySelector("#btn5").addEventListener("click", function(){
	fetch(ctx + "/ex43/sub05", {method : "post", headers : {"Content-Type" : "application/x-www-form-urlencoded"} , body : "address=seoul&age=33"});
...
document.querySelector("#btn2").addEventListener("click", function(){
	fetch(ctx + "/ex43/sub02?email=hm@daum.net&age=30")
});
