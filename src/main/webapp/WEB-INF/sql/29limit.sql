...
-- LIMIT : 중간 record만 조회
SELECT * FROM Customers WHERE CustomerID LIMIT 3, 3; -- 3번 인덱스부터 3개
SELECT * FROM Customers WHERE CustomerID ORDER BY CustomerID LIMIT 0, 3; -- 0번 인덱스부터 3개
SELECT * FROM Customers WHERE CustomerID ORDER BY CustomerID LIMIT 3; -- 위에서부터 3개
