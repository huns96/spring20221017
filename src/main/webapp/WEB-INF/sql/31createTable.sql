...
CREATE TABLE myTable02(
	name VARCHAR(255), age VARCHAR(255), address VARCHAR(255)
);
DESC myTable02;
...
-- Product
CREATE TABLE myProducts AS SELECT ProductID id, ProductName name, Price price FROM w3schools.Products;
DESC myProducts;
