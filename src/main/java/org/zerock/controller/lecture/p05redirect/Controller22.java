...
import lecture.p01lombok.JavaBean3;
...
public class Controller22 {
	...
	public String method5(HttpSession session) {
		...
		session.setAttribute(null, student);
		
		return "redirect:/ex/sub06";
	}
	...
	public String method9(RedirectAttributes rttr) {
		...
		j.setAvg(3.33);
		j.setClassName("korea");
		j.setLocation("seoul");
		j.setScore(200);
		j.setStudentNumber("13");
		
		rttr.addFlashAttribute("bean3", j);
	...
	public void method10(@ModelAttribute("bean3") JavaBean03 bean) {
